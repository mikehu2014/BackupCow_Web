...
namespace BackupCowWeb.Company
{
    ...
    public class TCompanyPcInfo {
        ...
        public string CloudIDNumber, EditionNumber;
        ...
        public void setEditionNumber(string _EditionNumber)
        {
    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        const string HttpReq_EditionNumber = "EditionNumber";
        const string HttpReq_DeviceType = "DeviceType";
        ...
        const string Cmd_BeServer = "beserver";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((Cmd != Cmd_Login) && (Cmd != Cmd_HeartBeat) && (Cmd != Cmd_Logout) && (Cmd != Cmd_AddServerNumber) && (Cmd != Cmd_ReadServerNumber) && (Cmd != Cmd_BeServer))
                return;
            ...
            string EditionNumber = HttpContext.Current.Request[HttpReq_EditionNumber];
            string DeviceType = HttpContext.Current.Request[HttpReq_DeviceType];
            ...
            {                   
                ...
                if ( Cmd == Cmd_Login )
                {
                    ...
                    NewComputerInfo.setEditionNumber(EditionNumber);
                    NewComputerInfo.setDeviceType(DeviceType);
                    NewComputerInfo.Status = "normal";
        ...
        private void login(string CompanyName, TCompanyPcInfo CompanyPcInfo)
        {
            ...
            sql = sql + "InternetIp, InternetPort, CloudIDNumber, EditionNumber, DeviceType, OnlineTime, Status ) values ";
            ...
            sql = sql + CompanyPcInfo.EditionNumber + "', '" + CompanyPcInfo.DeviceType + "', '" + CompanyPcInfo.OnlineTime;
            sql = sql + "', '" + CompanyPcInfo.Status + "')";
        ...
        private void heartBeat(string CompanyName, string PcID)
        {
            ...
            // 成为服务器 改变状态
        private void BeServer(string CompanyName, string PcID)
        {
            string sql = "UPDATE CompanyComputer SET Status = 'server' ";
            sql = sql + "where ( CompanyName = '" + CompanyName + "' and PcID = '" + PcID + "' )";
        ...
        private Dictionary<string, TCompanyPcInfo> getCompanyComputerList(string CompanyName, string CloudIDNumber)
        {
            ...
            while (sdr.Read())
            {
               ...
               string EditionNumber = sdr["EditionNumber"].ToString();
               string DeviceType = sdr["DeviceType"].ToString();
               ...
               PcInfo.setEditionNumber(EditionNumber);
               PcInfo.setDeviceType(DeviceType);
        ...
        private string getCompanyPcList( string CompanyName, string CloudIDNumber ) 
        {
            ...
            foreach( KeyValuePair< String, TCompanyPcInfo > p in CompanyPcInfoHash )
            {
                ...
                s = s + Split_PcPro + p.Value.EditionNumber;
                s = s + Split_PcPro + p.Value.DeviceType;
                s = s + Split_PcPro + p.Value.Status;
            }
