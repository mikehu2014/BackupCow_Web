...
namespace BackupCowWeb.Activate
{
    public class TrialInfo
    {
        ...
        public string pcName, ip, pcID, accountName;
        ...
        public void setAccountInfo(string _pcID, string _accountName)
        {
            pcID = _pcID;
    ...
    public class TrialHandle
    {
        ...
        {
            string sql = "Insert Into Trial (HardCode, PcName, IP, TrialDate, PcID, Account) Values ";
            sql = sql + "('" + t.hardCode + "', '" + t.pcName + "', '" + t.ip + "', '" + t.trialTime + "', '" + t.pcID + "', '" + t.accountName + "')";
            Conn con = new Conn();
