...
namespace BackupCowWeb.Order
{
    ...
    { 
        ...
        public void setUserInfo(string _email, string _Account)
        {
            email = _email;
            Account = _Account;
        }
        ...
        public void Add()
        {
            ...
            sql = sql + " UserCount, ActiveUser, AdditionCount, Email, AccountName, ServerCount )";
            sql = sql + " values ( '" + OrderID + "', " + Days + ", " + OrderEdition + ", '" + OrderDate + "', " + isValid + ", " + AdminId + ",";
            sql = sql + UserCount + ", " + ActiveUser + ", " + AdditionCount + ", '" + email + "', '" + Account + "', " + ClientCount + " )"; 
    ...
    public class Order
    {
        ...
        {
            Conn con = new Conn();
            string sql = "SELECT UserCount, ActiveUser, AdditionCount, OrderEdition, Days, ServerCount FROM Orders Where OrderID = '" + orderID + "'";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                int.TryParse(dt.Rows[0]["ServerCount"].ToString(), out ClientCount);
                ...
                OrderInfo.clientCount = ClientCount;
