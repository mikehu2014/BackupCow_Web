...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    &nbsp; &nbsp;
    <asp:Button ID="btnRefresh" runat="server" PostBackUrl="~/UseAnalyze.aspx?cmd=refresh"
        Text="Refresh" OnClick="btnRefresh_Click1" /><br />
    <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
        ConnectionString="<%$ ConnectionStrings:BackupCowConnectionString %>" OldValuesParameterFormatString="original_{0}" 
